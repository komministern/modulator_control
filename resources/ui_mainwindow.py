...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_modTrigLength.sizePolicy().hasHeightForWidth())
        self.lineEdit_modTrigLength.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_7.addWidget(self.groupBox_3, 4, 0, 1, 1)
        ...
        self.lineEdit_dqTrigLength = QLineEdit(self.groupBox_9)
        self.lineEdit_dqTrigLength.setObjectName(u"lineEdit_dqTrigLength")
        sizePolicy.setHeightForWidth(self.lineEdit_dqTrigLength.sizePolicy().hasHeightForWidth())
        self.lineEdit_dqTrigLength.setSizePolicy(sizePolicy)
        self.lineEdit_dqTrigLength.setMaximumSize(QSize(16777215, 16777215))
        self.lineEdit_dqTrigLength.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.lineEdit_dqTrigLength.setReadOnly(True)

        self.gridLayout_9.addWidget(self.lineEdit_dqTrigLength, 0, 1, 1, 1)

        self.horizontalSlider_dqTrigLength = QSlider(self.groupBox_9)
        self.horizontalSlider_dqTrigLength.setObjectName(u"horizontalSlider_dqTrigLength")
        ...
        self.horizontalSlider_dqTrigLength.setOrientation(Qt.Horizontal)

        self.gridLayout_9.addWidget(self.horizontalSlider_dqTrigLength, 0, 0, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.label_Sync.sizePolicy().hasHeightForWidth())
        self.label_Sync.setSizePolicy(sizePolicy4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_9.setTitle(QCoreApplication.translate("MainWindow", u"DQ Trig Length", None))
        self.lineEdit_dqTrigLength.setText(QCoreApplication.translate("MainWindow", u"12345 us", None))
