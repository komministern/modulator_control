...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.horizontalSlider_chargeTrigLength.sizePolicy().hasHeightForWidth())
        self.horizontalSlider_chargeTrigLength.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_chargeTrigLength.sizePolicy().hasHeightForWidth())
        self.lineEdit_chargeTrigLength.setSizePolicy(sizePolicy1)
        self.lineEdit_chargeTrigLength.setMaximumSize(QSize(75, 16777215))
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_dqTrigDelay.sizePolicy().hasHeightForWidth())
        self.lineEdit_dqTrigDelay.setSizePolicy(sizePolicy1)
        self.lineEdit_dqTrigDelay.setMaximumSize(QSize(75, 16777215))
        ...
        sizePolicy.setHeightForWidth(self.horizontalSlider_dqTrigDelay.sizePolicy().hasHeightForWidth())
        self.horizontalSlider_dqTrigDelay.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_modTrigDelay.sizePolicy().hasHeightForWidth())
        self.lineEdit_modTrigDelay.setSizePolicy(sizePolicy1)
        self.lineEdit_modTrigDelay.setMaximumSize(QSize(75, 16777215))
        ...
        sizePolicy1.setHeightForWidth(self.lineEdit_modTrigLength.sizePolicy().hasHeightForWidth())
        self.lineEdit_modTrigLength.setSizePolicy(sizePolicy1)
        self.lineEdit_modTrigLength.setMaximumSize(QSize(75, 16777215))
        ...
        self.gridLayout_9.addItem(self.verticalSpacer, 1, 2, 1, 1)
        ...
        self.radioButton_DQ = QRadioButton(self.groupBox_5)
        self.radioButton_DQ.setObjectName(u"radioButton_DQ")

        self.gridLayout_5.addWidget(self.radioButton_DQ, 0, 0, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.label_Sync.sizePolicy().hasHeightForWidth())
        self.label_Sync.setSizePolicy(sizePolicy3)
        ...
        self.menubar.setGeometry(QRect(0, 0, 544, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_DQ.setText(QCoreApplication.translate("MainWindow", u"Active", None))
        self.groupBox_8.setTitle("")
        self.pushButton_Apply.setText(QCoreApplication.translate("MainWindow", u"Apply", None))
        self.label_Sync.setText(QCoreApplication.translate("MainWindow", u"Sync", None))
    # retranslateUi
